...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
	...
	const GLchar* fragment_shader_with_version =
		...
		"void main()\n"
		"{\n"
		"	vec4 tColor = texture(Texture, Frag_UV.st);\n"
		"	ivec2 tSize = textureSize(Texture, 0);\n"
		"	if (tSize.x == 256 && tSize.y == 256)\n"
		"	{\n"
		"		tColor.rgb = 0.3334 * vec3(tColor.r + tColor.g + tColor.b);\n"
		"		tColor.rgb = 1.0 - tColor.rgb;\n"
		"	}\n"
		"	Out_Color = Frag_Color * tColor;\n"
...
/*
	...
	R"SRC(#version 300 es
		...
		void main()
		{
			...
			if (tSize.x == 256 && tSize.y == 256)
			{
				tColor.rgb = 0.3334 * (tColor.r + tColor.g + tColor.b);
				tColor.rgb = 1.0 - tColor.rgb;
			}
